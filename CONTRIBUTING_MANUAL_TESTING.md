...
1. **Verification:** The generated docs should use the Dark theme by default without the `--theme` flag.
...
1. Take a screenshot.
1. Note your Browser and OS.
1. Mention which theme was active.
1. File an issue on GitHub with the label `ui-regression`.
